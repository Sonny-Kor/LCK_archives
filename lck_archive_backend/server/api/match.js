...
router.get('/', (req, res) => {
  const sql = `SELECT m.match_id AS match_id, m.match_date AS match_data, t1.team_name AS team1_name, t1.team_logo AS team1_logo, m.team1_score AS team1_score, t2.team_name AS team2_name, t2.team_logo AS team2_logo, m.team2_score AS team2_score, m.youtube_link FROM _match m INNER JOIN team t1 ON m.team1_id = t1.team_id INNER JOIN team t2 ON m.team2_id = t2.team_id`;
